package com.perficient.testCases.Desktop.purdy;
...
public class Verify_Login_Page_with_valid_credentials extends TestCaseBase {
	...
	@Test(groups= {"regression", "smokes","desktop"},priority=0, dataProvider = "get_Data_Verify_Login_Page_with_valid_credentials")
	...
	public void redirectToLoginPage(Hashtable<String, String> dataTable) throws Exception
	{
		...
		customAssertion.assertTrue(homePage.verifySignInLinkDisplyed());
	...
	@Test(groups= {"regression", "smokes","desktop"},priority=2, dataProvider = "get_Data_Verify_Login_Page_with_valid_credentials")
